...
<body>
	...
	<div>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="<%=path%>/sensitiveword/sensitivewordjsondownload.action" id="show" class="btn btn-default" role="button">Download</a><br>
	</div>
	
	<table data-toggle="table"
       data-url="../sensitiveword/sensitiveword.json"
    ...
    <tr>
        <th data-field="account1">Sender</th>
        <th data-field="account2">Receiver</th>
        <th data-field="sendtime">SendTime</th>
        <th data-field="text">Content</th>
        <th data-field="sensitiveword">Sensitive Word</th>
    </tr>
    </thead>
</table>
